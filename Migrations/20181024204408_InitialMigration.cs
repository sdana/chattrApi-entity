    ...
    public partial class InitialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FavoritePeople", x => x.FavoritePeopleId);
                    table.ForeignKey(
                        name: "FK_FavoritePeople_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ChatAllowedUsers", x => x.ChatAllowedUsersId);
                    table.ForeignKey(
                        name: "FK_ChatAllowedUsers_Chatroom_ChatRoomId",
                        column: x => x.ChatRoomId,
                        principalTable: "Chatroom",
                        principalColumn: "ChatroomId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ChatAllowedUsers_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "ChatAllowedUsers",
                column: "ChatRoomId");

            migrationBuilder.CreateIndex(
                name: "IX_ChatAllowedUsers_UserId",
                table: "ChatAllowedUsers",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_FavoritePeople_UserId",
                table: "FavoritePeople",
                column: "UserId");
